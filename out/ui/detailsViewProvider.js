...
<body>
  <section>
    ...
    <div class="hint">Initialize a project to create <code>${escapeHtml(projectLocator_1.PROJECT_CONFIG_FILE)}</code>, <code>dashboards/</code>, <code>instances/</code>, and the first instance.</div>
